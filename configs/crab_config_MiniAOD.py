...
config = config()
config.General.requestName = 'MINIAOD_Production_UpsilonDzeroMuMu_GS'
config.General.workArea = 'crab_projects'
config.JobType.pluginName = 'Analysis' 
config.JobType.psetName = 'UpsilonToMuMuDzero_13TeV_MiniAOD_cfg.py'
...
config.Data.outputDatasetTag = 'MINIAOD_Production_UpsilonDzeroMuMu_GS'
config.Data.userInputFiles = open('file_AOD.txt').readlines()
