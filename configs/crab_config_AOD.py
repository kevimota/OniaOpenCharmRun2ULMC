...
config = config()
config.General.requestName = 'AOD_Production_UpsilonDzeroMuMu_GS'
config.General.workArea = 'crab_projects'
config.JobType.pluginName = 'Analysis' 
config.JobType.psetName = 'UpsilonToMuMuDzero_13TeV_AOD_cfg.py'
...
config.Data.outputDatasetTag = 'AOD_Production_UpsilonDzeroMuMu_GS'
config.Data.userInputFiles = open('file_HLT.txt').readlines()
