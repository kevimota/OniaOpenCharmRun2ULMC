...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/UpsilonToMuMuDplus_13TeV_cfi.py nevts:5000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:UpsilonToMuMuDplus_13TeV_GS.root'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.upsilonfilter+process.dplusfilter+process.upsilondaufilter+process.dplusdaufilter)
