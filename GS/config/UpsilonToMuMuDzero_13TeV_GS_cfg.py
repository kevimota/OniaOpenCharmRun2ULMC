...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/UpsilonToMuMuDzero_13TeV_cfi.py nevts:5000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:UpsilonToMuMuDzero_13TeV_GS.root'),
...
process.dzerodaufilter = cms.EDFilter("PythiaDauVFilter",
...
process.dzerofilter = cms.EDFilter("MCSingleParticleFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.upsilonfilter+process.dzerofilter+process.upsilondaufilter)
