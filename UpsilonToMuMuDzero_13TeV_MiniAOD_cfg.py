...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:UpsilonToMuMuDzero_13TeV_AOD.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:UpsilonToMuMuDzero_13TeV_MiniAOD.root'),
