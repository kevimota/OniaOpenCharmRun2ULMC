...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:UpsilonToMuMuDzero_13TeV_HLT.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:UpsilonToMuMuDzero_13TeV_AOD.root'),
