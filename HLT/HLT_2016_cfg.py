...
# with command line options: --filein file:DR_2016.root --fileout file:HLT_2016.root --mc --eventcontent RAWSIM --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --datatier GEN-SIM-RAW --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:25ns15e33_v4 --geometry DB:Extended --era Run2_2016 --python_filename HLT_2016_cfg.py -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:DR_2016.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HLT_2016.root'),
