...
# with command line options: --filein file:AOD.root --fileout file:MINIAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 106X_mc2017_realistic_v6 --step PAT --nThreads 1 --geometry DB:Extended --era Run2_2017 --python_filename MINIAOD_cfg.py -n -1 --no_exec
